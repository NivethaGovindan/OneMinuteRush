...
Public Class lb_pic_
    ...
    Private Sub lb_pic__Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("select PlayerName,Scores from wordsearchleaderboard where Rank=@s1", con)
            ...
            cmd2 = New OleDbCommand("select PlayerName,Scores from wordsearchleaderboard where Rank=@s2", con)
            ...
            cmd3 = New OleDbCommand("select PlayerName,scores from wordsearchleaderboard where Rank=@s3", con)
